	...
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header">
			...
			<div class="header-inner container">
				...
				?>
				<p class="site-description"><?php echo $bobagirls_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
											?></p>
			<?php endif; ?> -->
				</div><!-- .site-branding -->
				...
				<div class="language-select">
					<a lang="en=US" hreflang="en=US" href="<?php echo site_url('/en'); ?>">EN</a>
					|
					<a lang="fr=FR" hreflang="fr=FR" href="<?php echo site_url('/kr'); ?>">FR</a>
